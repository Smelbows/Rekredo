...
export const accordionData3 = [
  ...
  },
  {
    ...
    content: `Rekredo is a rental platform niched for production companies to source memorable, unique, crazy and hard to come by stuff that 
    individuals have in their home. Stuff like vintage Cars, famous paintings, one of a kind vas or other crazy stuff can now be found 
    and rented. Rekredo optimizes the way  `,
  },
];